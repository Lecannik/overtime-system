...
async def logout(
    ...
    if settings.AUTHENTIK_BASE_URL:
        ...
        sso_logout_url = f"{settings.AUTHENTIK_BASE_URL}/application/o/{settings.AUTHENTIK_APPLICATION_SLUG}/end-session/?client_id={settings.AUTHENTIK_CLIENT_ID}&post_logout_redirect_uri={frontend_url}/login"
